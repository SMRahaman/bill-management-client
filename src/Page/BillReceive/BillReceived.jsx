...
const BillReceived = () => {
    ...
    const receivedBillFilter=dueBillData.filter(bill=>bill.receiverName===user?.displayName);
    const FilterDatabyBill = receivedBillFilter.filter(
      (bill) =>
    ...
    return (
        <div className="mt-20">
        <h3 className="font-bold text-2xl">Received Bill by {user?.displayName}</h3>
